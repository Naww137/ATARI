...
from ATARI.sammy_interface.sammy_classes import SammyInputDataYW, SammyRunTimeOptions, SammyOutputData, SolverOPTs, SolverOPTs_EXT, SolverOPTs_YW
    ...
    **kwargs : dict, optional
    ...
    def __init__(self, **kwargs):
        ...
        if self.solver_options is None:
            if self.solver == "YW":
                self.solver_options = SolverOPTs_YW(max_steps = 50,
                                                    iterations = 3,
                                                    step_threshold=0.01,
                ...
                self.solver_options = SolverOPTs_EXT(max_steps = 50,
                                                    step_threshold=0.01,
                                                    LevMar=True, LevMarV=1.5,LevMarVd=5,
                                                    maxF=1e-5, minF=1e-8,
...
from ATARI.AutoFit.functions import concat_external_resonance_ladder
...
class eliminator_by_chi2:
    def __init__(self,
        ...
        self.rto = copy(solver.sammyRTO)
        self.rto.bayes = False
        self.rto_bayes = copy(solver.sammyRTO)
    ...
    def evaluate_prior(self, ladder):
        ...
        self.solver.sammyRTO = self.rto
        # self.solver.sammyINP.resonance_ladder = ladder
        sammy_OUT = self.solver.fit(ladder, [])
    ...
    def fit_YW_by_ig(self, 
        ...
        self.solver.sammyRTO = self.rto_bayes

        # self.solver.sammyINP.resonance_ladder = ladder_df
        self.solver.sammyINP.max_steps = max_steps
        self.solver.sammyINP.step_threshold = step_threshold
        self.solver.sammyINP.autoelim_threshold = None
        self.solver.sammyINP.LS = False
        self.solver.sammyINP.LevMar = True
        self.solver.sammyINP.initial_parameter_uncertainty = LevMarV0
        
        sammy_OUT = self.solver.fit(ladder_df, [])
