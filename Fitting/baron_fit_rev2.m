...
% figure(1); clf
% scatter(WE, WC, '.', 'DisplayName', 'Syndat exp'); hold on
...
Options=baronset('threads',8,'PrLevel',0,'MaxTime',15*60) ;%,'barscratch', sprintf('/home/nwalton1/regression_performance_testing/perf_test_baron_rev2/bar_%i/', isample));
