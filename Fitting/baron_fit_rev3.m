...
Options=baronset('threads',8,'PrLevel',0,'MaxTime',15*60, 'EpsA', fun_robust1(sol_w), 'barscratch', sprintf('/home/nwalton1/reg_perf_tests/perf_tests/staticladder/baron_rev3/bar_%i/', isample));
xtype=squeeze(char([repmat(["C","C","C"],1,NumPeaks),repmat(["B"],1,NumPeaks)]))';

%% format initial guess from pole position

if initial_guess
    w0 = zeros(1, 4 * NumPeaks);
