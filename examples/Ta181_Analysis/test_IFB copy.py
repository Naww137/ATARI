...
for case_id in bad_cases_ids:
    ...
    sammy_rto_fit = sammy_classes.SammyRunTimeOptions(sammypath,
                                            ...
                                            "bayes":   True,
                                            "keep_runDIR": True,
                                            "sammy_runDIR": "sammy_runDIR_copy"
                                            })
    ...
    filehandler.close()
    # filehandler = open(f"/Users/noahwalton/Documents/GitHub/ATARI/examples/Ta181_Analysis/true_{case_id}_inLM.pkl", 'wb')
    # pickle.dump(true_out, filehandler)
    # filehandler.close()
    # filehandler = open(f"/Users/noahwalton/Documents/GitHub/ATARI/examples/Ta181_Analysis/samout_{case_id}.pkl", 'wb')
