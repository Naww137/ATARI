...
__doc__ = """
This file contains the spingroup assignment algorithm. `RunMaster` is used as a pre- and
    ...
    def WigSample(s, num_trials:int=1,
        ...
        for tr in range(num_trials):
            ...
            for i in range(1,L+1):
                ...
                # Precaution if there are just so many missing resonances that WigSample freaks out.
                if np.sum(likelihoods) == 0.0:
                    likelihoods = np.ones_like(likelihoods)
