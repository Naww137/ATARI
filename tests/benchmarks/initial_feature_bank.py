...
exp_model_T = Experimental_Model(reaction='transmission', title='trans', energy_range=energy_range)
exp_model_Y = Experimental_Model(reaction='capture', title='cap', energy_range=energy_range)
...
fig = myplot.plot_reduced_data_TY(datasets=datasets,
                            ...
                            fits_chi2= outs.sammy_outs_fit_2[-1].chi2,
