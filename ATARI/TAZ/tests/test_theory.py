...
class TestPenetration(unittest.TestCase):
    ...
    def test_penetration_iterative(self):
        """
        Tests the penetration factor equations by relating the iterative representation with the explicit representation of the penetration factor.
        """
    ...
    def test_penetration_against_ATARI(self):
        """
        Tests the penetration factor equations against the ATARI penetration evaluation.
        """
...
[1.396401931705e-20, 4.414072108069e-16, 1.390363976487e-11, 4.226136876804e-07, 8.802711790969e-03, 3.598673712290e+00, 1.692243731651e+01]])
        for l in Ls:
            k = Theory.RMatrix.k_wavenumber(mass_targ, E, mass_proj)
            rho = Theory.RMatrix.rho(k, ac)
            P_TAZ = Theory.RMatrix.penetration_factor(rho, l)
            P_ATARI_l = P_ATARI[l,:]
