function [w, fval, barout2] = run_baron(xs_func, NumPeaks, WC, WE, run_baron_bool, initial_vec, polynomial_terms, constraints, Options)
...
if run_baron_bool
    ...
    %     Options=baronset('threads',8,'PrLevel',1,'DeltaTerm',1,'EpsA',0.1,'MaxTime',5*60);
        ...
        if isempty(initial_vec)
            initial_vec = NaN(1,4*NumPeaks+polynomial_terms);
        end
