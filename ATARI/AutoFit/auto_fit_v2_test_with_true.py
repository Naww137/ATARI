...
class AutoFit2:
    ...
    def fit(self, evaluation_data:Evaluation_Data, total_resonance_ladder:pd.DataFrame, fixed_resonance_indices:list=[], true_ladder=None):
        ...
        self.output.whitening_model = sammyOUT
        folds_data = self.cross_validation(evaluation_data, sammy_out_theo=sammyOUT,
        ...
        self.output.Nres_target = Nres_selected
